 ...
 */
function itcr_form_alter( array & $form, array & $form_state = array(), $form_id = NULL ) {
 ...
 * @see hook_theme()
 */
function itcr_theme( & $existing, $type, $theme, $path ) {
	// Custom theme hooks:
 ...
 */
function itcr_preprocess_search_result( & $variables ) {
